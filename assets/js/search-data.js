    ...
    handler: () => {
      window.location.href = "/zh/";
        ...
        handler: () => {
            ...
            window.location.href = "/zh/assets/pdf/example_pdf.pdf";
        ...
        handler: () => {
            ...
            window.location.href = "/zh/blog/2021/distill/";
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
              window.location.href = "/zh/books/the_godfather/";
          ...
          section: "News",handler: () => {
              window.location.href = "/zh/news/announcement_2/";
          ...
          section: "Projects",handler: () => {
              window.location.href = "/zh/projects/5_project/";
            },},{id: "projects-project-6",
          title: 'project 6',
          description: "a project with no image",
          section: "Projects",handler: () => {
              window.location.href = "/zh/projects/6_project/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://instagram.com/hasiilapinou", "_blank");
        },
      },{
        id: 'social-youtube',
        title: 'YouTube',
        section: 'Socials',
        handler: () => {
          window.open("https://youtube.com/@hasiizh", "_blank");
        },
      },{
        id: 'social-bluesky',
        title: 'Bluesky',
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/hasiizh.bsky.social", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
